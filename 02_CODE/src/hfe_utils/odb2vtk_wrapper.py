...
class Odb2VtkWrapper:
    def __init__(self, odb2vtk_path, odb_path, cfg):
...
def test():
    ...
    odb_path = "/home/simoneponcioni/Desktop/odb2vtk_tests/C0002224_01.odb"

    wrapper = Odb2VtkWrapper(odb2vtkpath, odb_path, cfg)
